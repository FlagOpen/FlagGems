...
print(f"TRION_PACKAGE_NAME: {triton_package_name}")
...
setup(
    ...
    # triton requires python>=3.10.10 for builtin packages inspect to correctly
    # get source from triton jit functions.
    ...
    install_requires=[
        f"{triton_package_name}>=3.0.0",
        "torch>=2.4.0",  # To use custom op
        "transformers>=4.40.2",
    ],
    extras_require={
        "test": [
