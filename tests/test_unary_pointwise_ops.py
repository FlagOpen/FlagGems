...
def test_accuracy_atan(shape, dtype):
    ...
    ref_out = torch.ops.aten.atan.default(ref_inp)
    with flag_gems.use_gems():
        res_out = torch.ops.aten.atan.default(res_inp)
...
def test_accuracy_atan_(shape, dtype):
    ...
    ref_out = torch.ops.aten.atan_.default(ref_inp)
    with flag_gems.use_gems():
        res_out = torch.ops.aten.atan_.default(res_inp)
