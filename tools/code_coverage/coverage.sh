...
rm -rf /home/zhangbo/FlagGems-CI/PR_Coverage/PR${PR_ID}/${ID_SHA}/${PR_ID}-${GITHUB_SHA}-python-coverage-full
rm -rf /home/zhangbo/FlagGems-CI/PR_Coverage/PR${PR_ID}/${ID_SHA}/${PR_ID}-${GITHUB_SHA}-python-coverage-diff
rm -rf /home/zhangbo/FlagGems-CI/PR_Coverage/PR${PR_ID}/${ID_SHA}/${PR_ID}-${GITHUB_SHA}-python-coverage-diff-discard
...
FILES="/home/zhangbo/FlagGems-CI/PR_Coverage/PR${PR_ID}/${ID_SHA}/${ID_SHA}-op* /home/zhangbo/FlagGems-CI/PR_Coverage/PR${PR_ID}/${ID_SHA}/${ID_SHA}-model*"
...
if [ -s "${ID_SHA}-python-coverage-diff.info" ]; then
    ...
    echo -e "\n================================================================"
    mv -f ${ID_SHA}* /home/zhangbo/FlagGems-CI/PR_Coverage/PR${PR_ID}/${ID_SHA}
    exit
fi
...
lcov --list /home/zhangbo/FlagGems-CI/PR_Coverage/PR${PR_ID}/${ID_SHA}/${ID_SHA}-python-coverage-discard-diff.info
echo -e "\n==================== Python Coverage Result ====================\n"
${PYTHON_BIN} ${FlagGemsROOT}/tools/code_coverage/coverage_lines.py  /home/zhangbo/FlagGems-CI/PR_Coverage/PR${PR_ID}/${ID_SHA}/${ID_SHA}-python-coverage-discard-diff.info 0.9
