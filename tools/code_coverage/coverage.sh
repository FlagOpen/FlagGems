...
python3.11 ${FlagGemsROOT}/tools/code_coverage/python_coverage.py > python-coverage.info
...
# git
COVERAGE_DIFF_PATTERN="`python3.11 ${FlagGemsROOT}/tools/code_coverage/pull_request.py files ${PR_ID}`"
echo ${COVERAGE_DIFF_PATTERN}
python3.11 ${FlagGemsROOT}/tools/code_coverage/pull_request.py diff ${PR_ID} > python-git-diff.out
...
python3.11 ${FlagGemsROOT}/tools/code_coverage/coverage_diff.py python-coverage-diff.info python-git-diff.out > python-coverage-diff.tmp
...
python3.11 ${FlagGemsROOT}/tools/code_coverage/jit_func_position.py ${COVERAGE_DIFF_PATTERN} > python-triton-jit-position.info
python3.11 ${FlagGemsROOT}/tools/code_coverage/coverage_diff_discard.py python-coverage-diff.info python-triton-jit-position.info > python-coverage-discard-diff.info
...
python3.11 ${FlagGemsROOT}/tools/code_coverage/coverage_lines.py  python-coverage-discard-diff.info 0.9
