...
def enable(lib=aten_lib):
    ...
    lib.impl("normal.Tensor_float", normal, "CUDA")
    lib.impl("normal.float_Tensor", normal, "CUDA")
    lib.impl("normal.Tensor_Tensor", normal, "CUDA")
    lib.impl("normal.float_float", normal, "CUDA")
