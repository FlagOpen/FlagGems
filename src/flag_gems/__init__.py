...
def enable(
    ...
    current_work_registrar = registrar(
        (
            ("_flash_attention_forward", flash_attention_forward, Autograd.disable),
            ...
            ("divide.Tensor", true_divide, Autograd.disable),
            ...
            ("divide_.Tensor", true_divide_, Autograd.disable),
            ...
            ("true_divide.Tensor", true_divide, Autograd.disable),
            ("true_divide_.Scalar", true_divide_, Autograd.disable),
            ("true_divide_.Tensor", true_divide_, Autograd.disable),
