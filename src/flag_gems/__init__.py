...
def enable(lib=aten_lib):
    ...
    lib.impl("bitwise_or.Tensor", bitwise_or_tensor, device_key)
    lib.impl("bitwise_or.Scalar", bitwise_or_scalar, device_key)
    lib.impl("bitwise_or.Scalar_Tensor", bitwise_or_scalar_tensor, device_key)
