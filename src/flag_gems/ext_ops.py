...
if True:
    ...
    @torch.library.register_fake("flag_gems::add.Tensor")
    def _(a, b):
        return a + b

    @torch.library.custom_op(
        "my::maybe_reduce", device_types=("cuda",), mutates_args=()
    )
    ...
    torch.library.register_autograd(
        "flag_gems::add.Tensor", _backward, setup_context=_setup_context
    )
