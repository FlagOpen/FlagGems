...
def masked_select_kernel(
    ...
    d_width = inp_ptr.dtype.element_ty.primitive_bitwidth  # floor_div(8) in one line throws compiling error
...
def cast_bool2float_kernel(
    ...
    for offset in tl.range(offset_start, n_elements, step):
        ...
        select_mask = tl.load(select_mask_ptr + offsets, mask=mask, other=0.0).to(tl.float32)
