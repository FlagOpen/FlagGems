...
eps = [2.220446049250313e-16, 1.1920928955078125e-07, 0.0009765625, 0.0078125] # eps for double, float, float16, bfloat16
eps_1 = [ -0.5 * x for x in eps]
eps_2 = [ 1.0 + x for x in eps_1]
