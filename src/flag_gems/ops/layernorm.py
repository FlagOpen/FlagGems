...
def cfggen_in_wb_bw():
    configs = [
        triton.Config({"BLOCK_ROW_SIZE": 1, "BLOCK_COL_SIZE": 4096}, num_warps=1, num_stages=1),
        triton.Config({"BLOCK_ROW_SIZE": 4, "BLOCK_COL_SIZE": 1024}, num_warps=1, num_stages=1),
        triton.Config({"BLOCK_ROW_SIZE": 4, "BLOCK_COL_SIZE": 2048}, num_warps=1, num_stages=1),
        triton.Config({"BLOCK_ROW_SIZE": 8, "BLOCK_COL_SIZE": 1024}, num_warps=1, num_stages=1),
        triton.Config({"BLOCK_ROW_SIZE": 22, "BLOCK_COL_SIZE": 512}, num_warps=1, num_stages=1),
        triton.Config({"BLOCK_ROW_SIZE": 32, "BLOCK_COL_SIZE": 256}, num_warps=1, num_stages=1),
    ]
    return configs
